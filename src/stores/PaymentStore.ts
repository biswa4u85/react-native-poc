...
import CezerinWorker from '../services/CezerinWorker'
...
export const actions = {
    fetchPayments: async (dispatch) => {
        ...
        const json = await CezerinWorker.getPayments();
        ...
        dispatch({type: types.PAYMENT_FETCH_FAILURE});
            ...
            dispatch({type: types.PAYMENT_FETCH_SUCCESS, payload: json, finish: true});
        }
    },
};
